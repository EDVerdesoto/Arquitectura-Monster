 ...
 *
 * Recibe la acción del LoginActivity (View), invoca al RestClient (Model)
...
public class LoginController {
    ...
    public LoginController(RestClient restClient, ExecutorService executorService) {
    ...
    public void login(String baseUrl, String usuario, String clave, LoginCallback callback) {
        executorService.execute(() -> {
            try {
                String token = restClient.login(baseUrl, usuario, clave).get();
