    ...
    public class MenuVista
    {
        ...
        public int MostrarMenuPrincipal(bool autenticado)
        {
            ...
            if (autenticado)
            {
                ...
                Console.WriteLine("3. Conversion de Longitud");
                Console.WriteLine("4. Conversion de Temperatura");
                Console.WriteLine("5. Conversion de Masa");
                Console.WriteLine("6. Validar Campo Numerico");
                Console.WriteLine("7. Salir");
            }
            else
            {
                Console.WriteLine("1. Iniciar Sesion");
                Console.WriteLine("2. Recuperar Contrasena");
