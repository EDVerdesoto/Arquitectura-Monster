 ...
 * 
 */
@WebServiceClient(name = "WSLogin", targetNamespace = "http://WebServices.monster.edu.ec/", wsdlLocation = "http://localhost:8080/WS_ConUni_Java_GR03/WSLogin?wsdl")
    ...
    extends Service
{
    ...
    private static final QName WSLOGIN_QNAME = new QName("http://WebServices.monster.edu.ec/", "WSLogin");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WS_ConUni_Java_GR03/WSLogin?wsdl");
    ...
    public WSLogin getWSLoginPort() {
        return super.getPort(new QName("http://WebServices.monster.edu.ec/", "WSLoginPort"), WSLogin.class);
    }
    ...
    public WSLogin getWSLoginPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://WebServices.monster.edu.ec/", "WSLoginPort"), WSLogin.class, features);
    }
